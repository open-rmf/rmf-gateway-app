 ...
 */
package org.openrmf.gatewayapp.rvr.ui;
...
public class JoystickSurfaceView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public float[] getOrigins() {
        return new float[] {origin_x, origin_y};
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (touchOkay) {
            ...
            Log.i("DEBUG X", String.valueOf(touched_x));
            Log.i("DEBUG Y", String.valueOf(touched_y));
            Log.i("DEBUG ACTION", String.valueOf(action));
            outside = false;
            switch (action) {
